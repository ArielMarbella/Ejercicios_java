...
public class Tema06Ejercicio25 {
	
	public static void main (String args[]) {
		
    System.out.println("Escribe un programa que te permita hacer lo siguiente:");
    
    for(int i =0;i<100;i++){
      
      int numero = (int)(Math.random()*191)+10;
      
      //comprobemos si este numero es primo
      ...
      if(primo){
        ...
        }else if((numero%5)==0){//multiplo de 5
          System.out.print("[" + numero+"]");
          }else{
            System.out.print(" "+numero+" ");
            }
